const documentTypeMap: { [key: string]: string } = {
  ...
  const occupationalStatusMap: { [key: string]: string } = {
    A: 'Dipendente',
    B: 'Imprenditore',
  ...
  const serviceBookingTypeMap: { [key: string]: string } = {
  ...
  const firstLevelCompetenceMap: { [key: string]: string } = {
  ...
  const secondLevelCompetenceMap: { [key: number]: string } = {
  ...
  const publicServiceDomainMap: { [key: string]: string } = {
    A: 'App IO',
  ...
  const discoveryMethodServiceMap: { [key: string]: string } = {
    A: 'Sportello',
    B: 'Telefono',
    C: 'Sito internet',
    D: 'Social media',
  ...
  const bookingReasonMap: { [key: string]: string } = {
  ...
  const repeatExperienceMap: { [key: string]: string } = {
  ...
  const digitalProblemSolvingMap: { [key: string]: string } = {
