    ...
    return (
        <div className='container'>
            <div className='d-flx flex-column align-items-start'>
                ...
                <span style={{margin: '0 15px'}}>|</span>
                <a href={'#volontari'}>Informativa Volontari</a>
                ...
                <section id={'volontari'}>
                    <h4 className='mt-4 mb-3 primary-color-a9'>
                        Informativa sul trattamento dei dati personali degli Operatori volontari 
                        nell’ambito della Missione 1 - Componente 1 - Asse 1 -
                        Misura 1.7.1 “Servizio civile digitale” del Piano
                        Nazionale di Ripresa e Resilienza

                    </h4>
                    <p>
                        La presente informativa resa dal Dipartimento per le Politiche Giovanili e il Servizio Civile Universale della
                        Presidenza del Consiglio dei ministri (di seguito, anche  <strong>“DPGSCU”</strong>) descrive le modalità di trattamento dei 
                        dati personali degli Operatori Volontari del Servizio Civile Digitale (di seguito, anche i <strong>“Volontari”</strong>) all’interno
                        della piattaforma di monitoraggio “Facilita” (la <strong>“Piattaforma”</strong>) messa a disposizione dal Dipartimento per la
                        Trasformazione Digitale della Presidenza del Consiglio dei Ministri per lo svolgimento degli interventi di 
                        facilitazione digitale condotti nell’ambito della Missione 1 - Componente 1 - Asse 1 - Misura 1.7.1 “Servizio 
                        civile digitale” del Piano Nazionale di Ripresa e Resilienza. L’informativa è resa ai sensi dell’art. 13 del 
                        Regolamento (UE) 2016/679 (il <strong>“Regolamento”</strong>).
                    </p>
                    ...
                    <p>
                        Il Titolare del trattamento è la Presidenza del Consiglio dei ministri - Dipartimento per le politiche giovanili e 
                        il Servizio civile universale, con sede in Via della Ferratella in Laterano 51, 00184 Roma, contattabile ai 
                        seguenti recapiti:
                    </p>
                    <ul className='mt-2 mb-2 ml-5'>
                        <li>
                            <strong>PEC: </strong>
                            <a href='mailto:giovaniserviziocivile@pec.governo.it'>
                                giovaniserviziocivile@pec.governo.it
                            </a>
                        </li>
                    </ul>
                    ...
                    <p>
                        Il DPGSCU tratterà dati di natura comune, anagrafici e di contatto, quali nome, cognome, codice fiscale, 
                        indirizzo e-mail e numero di telefono (facoltativo) dei Volontari, associati alle attività svolte come di seguito 
                        precisato. I dati anagrafici e di contatto potranno essere verificati e rettificati dall’interessato al primo 
                        accesso in Piattaforma. 
                    </p>
                    <br/>
                    <p>
                        Il mancato conferimento dei dati personali richiesti non consente ai Volontari di svolgere
                        gli interventi di facilitazione.
                    </p>
                    <br/>
                    <p>
                        ...
                        di facilitazione e monitoraggio e, comunque, fino al termine delle verifiche UE della misura –
                        scadenza
                        per raggiungimento target dicembre 2025.
                    ...
                    <p>
                        Per accedere a Facilita sarà necessario autenticarsi mediante SPID o CIE. L'ID univoco di sessione del sistema 
                        di autenticazione scelto associato all'utente verrà registrato insieme ai dati relativi alle operazioni effettuate 
                        (es. data accesso/uscita, operazione richiesta, etc.). Tali dati saranno trattati per un anno dalla loro raccolta, 
                        fatte salve esigenze di conservazione ulteriore in caso di eventuali contenziosi
                    </p>
                    ...
                    <p>
                        I dati dei Volontari sono trattati dal DPGSCU esclusivamente per finalità <strong>connesse e strumentali</strong> allo 
                        svolgimento delle attività di facilitazione nell’ambito dell’attuazione della Missione 1 - Componente 1 - Asse 
                        1 - Misura 1.7.1 “Servizio civile digitale” del Piano Nazionale di Ripresa e Resilienza, anche con l’uso di 
                        procedure informatizzate, nei modi e limiti necessari per perseguire tali finalità. 

                    </p>
                    <br/>
                    <p>
                        In particolare, il DPGSCU tratta i dati dei Volontari al fine di:
                        (i) consentire ai Volontari la registrazione in Piattaforma degli interventi di facilitazione
                        digitale;
                        (ii) consentire ai Volontari l’utilizzo di un ambiente all’interno del quale gli stessi
                        possano interagire e condividere
                        le proprie conoscenze (l’ambiente di <strong>“Knowledge Management”</strong>);
                        (iii) effettuare il monitoraggio e la verifica della Misura 1.7.1 e del collegato target
                        M1C1-24, nell’esecuzione
                        dei propri compiti di interesse pubblico o comunque connessi all’esercizio
                        dei propri pubblici poteri (art. 6, par. 1, lett. e del Regolamento), con riferimento
                        al Regolamento (UE) 2021/241 del Parlamento europeo e del Consiglio del 12 febbraio 2021 che
                        istituisce il dispositivo per la ripresa e la resilienza,
                    ...
                    <br/>
                    <p>
                        Sono destinatari dei dati i seguenti soggetti:
                    </p>
                    <ul className='mt-2 mb-2 ml-5'>
                        <li>
                            <p>
                                il Dipartimento per la trasformazione digitale della Presidenza del Consiglio dei ministri che 
                                opera in qualità di Responsabile del trattamento ai sensi e per gli effetti di cui 
                                all’Accordo ex articolo 28 del Regolamento, sottoscritto tra la Presidenza del Consiglio dei ministri 
                                – Dipartimento per le Politiche giovanili e il Servizio civile universale e la Presidenza del Consiglio 
                                dei ministri – Dipartimento per la trasformazione digitale, in data 10 luglio 2023, che qui si intende 
                                integralmente richiamato
                            </p>
                        </li>
                        <li>
                            <p>
                                le società Enterprise Services Italia S.r.l., DS Tech S.r.l. e Amazon Web Service EMEA SARL, che 
                                operano in qualità di Sub-responsabili su nomina del Dipartimento per la trasformazione digitale, 
                                quali fornitori incaricati dei servizi di sviluppo, erogazione e gestione operativa della Piattaforma.
                            </p>
                        </li>
                    </ul>
                    ...
                    <p>
                        Tali diritti potranno essere esercitati scrivendo al DPGSCU via PEC a <a href='mailto:giovanieserviziocivile@pec.governo.it'>giovanieserviziocivile@pec.governo.it</a>. 
                    </p>
                    <p>
                        Per i trattamenti dei dati personali di cui alla presente informativa, gli interessati hanno anche il diritto di 
                        presentare un reclamo all’autorità di controllo.
                    </p>
                    <p>
                        Per informazioni sulle funzionalità della Piattaforma è possibile rivolgersi al Dipartimento per la 
                        trasformazione digitale scrivendo a {' '}
                        <a href='mailto:supporto-facilita@repubblicadigitale.gov.it'>
                            supporto-facilita@repubblicadigitale.gov.it
                        </a>
                        .
