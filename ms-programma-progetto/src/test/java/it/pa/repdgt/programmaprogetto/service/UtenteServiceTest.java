...
public class UtenteServiceTest {
	...
	public void countFacilitatoriPerSedeProgettoEnteTest() {
		when(utenteRepository.countFacilitatoriPerSedeProgettoEnte(progetto1.getId(), sede1.getId(), ente1.getId())).thenReturn(2);
		utenteService.countFacilitatoriPerSedeProgettoEnte(progetto1.getId(), sede1.getId(), ente1.getId());
		verify(utenteRepository, times(1)).countFacilitatoriPerSedeProgettoEnte(progetto1.getId(), sede1.getId(), ente1.getId());
	}
