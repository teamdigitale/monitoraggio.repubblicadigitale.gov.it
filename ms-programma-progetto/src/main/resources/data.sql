...
-- CREAZIONE ANAGRAFICA RUOLI
 ...
 insert into programma(id, nome, cup, nome_breve, policy, stato, data_ora_creazione, codice)
	values(100, 'Programma Alfa', 'A100', 'Programma Alfa', 'SCD', 'ATTIVO', CURRENT_TIME( ), '1111');
 insert into programma(id, nome, cup, nome_breve, policy, stato, data_ora_creazione, codice)
	values(101, 'Programma Beta', 'B101', 'Programma Beta', 'SCD', 'ATTIVO', CURRENT_TIME( ), '2222');
 insert into programma(id, nome, cup, nome_breve, policy, stato, data_ora_creazione, codice)
	values(102, 'Programma Gamma','G102', 'Programma Gamma', 'SCD', 'ATTIVO', CURRENT_TIME( ), '3333');
 insert into programma(id, nome, cup, nome_breve, policy, stato, data_ora_creazione, codice)
	values(103, 'Programma Sigma','D103', 'Programma Sigma', 'SCD', 'ATTIVO', CURRENT_TIME( ), '4444');
 insert into programma(id, nome, cup, nome_breve, policy, stato, data_ora_creazione, codice)
	values(104, 'Programma Rho', 'R104', 'Programma Rho', 'SCD', 'ATTIVO', CURRENT_TIME( ), '5555');
 insert into programma(id, nome, cup, nome_breve, policy, stato, data_ora_creazione, codice)
	values(105, 'Programma Tau', 'T105', 'Programma Tau', 'SCD', 'ATTIVO', CURRENT_TIME( ), '6666');
