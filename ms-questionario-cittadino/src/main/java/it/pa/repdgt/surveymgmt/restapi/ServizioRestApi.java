...
public class ServizioRestApi {
	...
	public ServiziPaginatiResource getAllServiziPaginatiByProfilaRzioneUtenteLoggatoAndFiltri(
		...
		return new ServiziPaginatiResource(serviziResource, paginaServizio.getTotalPages(),
				paginaServizio.getTotalElements());
	}

	/***
	 * Recupera i dati da mostrare nella scheda dettaglio servizio a partire dall'id
	 * del servizio
	 * 
	 */
	...
	/**
	 * Recupera tutte le 'tipolgie servizio' da mostrare nella dropdown dei filtri
	 * per i servizi
	 * 
	 */
	...
	/**
	 * Recupera gli stati servizio da mostrare nella dropdown dei filtri per i
	 * servizi
	 * 
	 */
	...
	public ResponseEntity<InputStreamResource> downloadCSVSElencoServizi(
		...
		final FiltroListaServiziParam filtroListaServiziParam = new FiltroListaServiziParam(
				...
				tipologieServiziFiltro,
				statiFiltro);
		final List<ServizioEntity> serviziEntity = this.servizioService
				.getAllServiziByProfilazioneUtenteLoggatoAndFiltri(
						profilazioneParam,
						filtroListaServiziParam);
		final List<ServizioResource> serviziResource = this.servizioMapper.toResourceFrom(serviziEntity);
		final ByteArrayInputStream byteArrayInputStream = CSVServizioUtil.exportCSVServizi(serviziResource,
				CSVFormat.DEFAULT);
