...
//import it.pa.repdgt.surveymgmt.service.UISchemaService;
...
//@Slf4j
//@Deprecated
//public class UISchemaTemplateQuestionarioRestApi {
//	@Autowired
...
//	 * */
//	@Deprecated
//	@PutMapping(path = "/{id}/uischema")
//	public Response<QuestionarioTemplateResource> updateTemplateWithUISchema(
...
//			@ApiParam(name = "schema", value = "json uiSchema template questionario" ,required = true)
//			@RequestBody @NotBlank @JsonString String uiSchema,
//			BindingResult bindingResult ) {
//		log.info("===> PUT /rest/api/v1/schema/{}/uischema", idTemplateQuestionario);
//		QuestionarioTemplateCollection templateQuest = this.uischemaService.saveByIdTemplate(idTemplateQuestionario, uiSchema);
