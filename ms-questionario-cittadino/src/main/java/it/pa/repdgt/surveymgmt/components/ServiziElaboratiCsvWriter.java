...
public class ServiziElaboratiCsvWriter extends GenericImportCsvWriter<ServiziElaboratiDTO, HeaderCSV> {
    ...
    private void convertFieldsToRiga(ServiziElaboratiDTO model, StringBuilder fileContent, Integer i) {
        ...
        fileContent.append(model.getNuovoCittadinoServizioRequest().getNumeroDocumento() != null
                ...
                : "").append(",");
        fileContent.append(CSVMapUtil.getAN7Map().get(model.getNuovoCittadinoServizioRequest().getGenere()) != null
                ? CSVMapUtil.getAN7Map().get(model.getNuovoCittadinoServizioRequest().getGenere())
                : "").append(",");
        if (model.getNuovoCittadinoServizioRequest().getFasciaDiEtaId() != null) {
            fileContent.append(
                    CSVMapUtil.getAN8Map().get(model.getNuovoCittadinoServizioRequest().getFasciaDiEtaId()) != null
                            ? CSVMapUtil.getAN8Map().get(model.getNuovoCittadinoServizioRequest().getFasciaDiEtaId())
                            : "")
                    .append(",");
        } else {
        ...
        fileContent
                .append(CSVMapUtil.getAN9Map().get(model.getNuovoCittadinoServizioRequest().getTitoloStudio()) != null
                        ? CSVMapUtil.getAN9Map().get(model.getNuovoCittadinoServizioRequest().getTitoloStudio())
                        : "")
                .append(",");
        fileContent.append(
                CSVMapUtil.getAN10Map().get(model.getNuovoCittadinoServizioRequest().getStatoOccupazionale()) != null
                        ? CSVMapUtil.getAN10Map().get(model.getNuovoCittadinoServizioRequest().getStatoOccupazionale())
                        : "")
                .append(",");
        fileContent
                .append(CSVMapUtil.getAN11Map().get(model.getNuovoCittadinoServizioRequest().getCittadinanza()) != null
                        ? CSVMapUtil.getAN11Map().get(model.getNuovoCittadinoServizioRequest().getCittadinanza())
                        : "")
                .append(",");
        ...
        fileContent.append(model.getServizioRequest().getDataServizio() != null
                ...
                : "").append(",");
        fileContent.append(
                model.getServizioRequest().getDurataServizio() != null ? model.getServizioRequest().getDurataServizio()
                        : "")
                .append(",");
        fileContent.append(appendSplitValues(model.getCampiAggiuntiviCSV().getTipologiaServiziPrenotato(),
                CSVMapUtil.getSE3Map()) != null
                        ? appendSplitValues(model.getCampiAggiuntiviCSV().getTipologiaServiziPrenotato(),
        ...
        fileContent.append(appendSplitValues(model.getCampiAggiuntiviCSV().getCompetenzeTrattatePrimoLivello(),
                CSVMapUtil.getSE4Map()) != null
                        ? appendSplitValues(model.getCampiAggiuntiviCSV().getCompetenzeTrattatePrimoLivello(),
