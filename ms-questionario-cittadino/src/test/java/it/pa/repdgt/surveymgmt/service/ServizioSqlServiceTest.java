...
public class ServizioSqlServiceTest {
	 ...
	 * when(this.servizioSqlRepository.findById(servizio.getId())).thenReturn(
	 * Optional.of(servizio));
	 * ServizioEntity risultato =
	 * servizioSqlService.getServizioById(servizio.getId());
	 ...
	 * servizioSqlService.getAllServiziByPolicySCDAndFiltro(
	 * filtroListaServizi.getCriterioRicerca(),
	 * filtroListaServizi.getTipologieServizi(),
	 * filtroListaServizi.getStatiServizio());
	 * assertThat(risultato.size()).isEqualTo(listaServizi.size());
	 ...
	 * when(this.servizioSqlRepository.
	 * findAllServiziByFacilitatoreOVolontarioAndFiltro(
	 * filtroListaServizi.getCriterioRicerca(),
	 ...
	 * )).thenReturn(listaServizi);
	 * List<ServizioEntity> risultato =
	 * servizioSqlService.getAllServiziByFacilitatoreOVolontarioAndFiltro(
	 * filtroListaServizi.getCriterioRicerca(),
	 * Arrays.asList(sceltaprofiloParam.getIdProgramma().toString()),
	 * Arrays.asList(sceltaprofiloParam.getIdProgetto().toString()),
	 * sceltaprofiloParam.getIdEnte(),
	 ...
	 * {
	 * when(this.servizioSqlRepository.
	 * findAllServiziByReferenteODelegatoGestoreProgrammaAndFiltro(
	 * filtroListaServizi.getCriterioRicerca(),
	 * Arrays.asList(sceltaprofiloParam.getIdProgramma().toString()),
	 * filtroListaServizi.getTipologieServizi(),
	 * filtroListaServizi.getStatiServizio()
	 * )).thenReturn(listaServizi);
	 * List<ServizioEntity> risultato = servizioSqlService.
	 ...
	 * when(this.servizioSqlRepository.
	 * findAllServiziByReferenteODelegatoGestoreProgettoAndFiltro(
	 * filtroListaServizi.getCriterioRicerca(),
	 * Arrays.asList(sceltaprofiloParam.getIdProgramma().toString()),
	 * Arrays.asList(sceltaprofiloParam.getIdProgetto().toString()),
	 * filtroListaServizi.getTipologieServizi(),
	 ...
	 * )).thenReturn(listaServizi);
	 * List<ServizioEntity> risultato =
	 * servizioSqlService.getAllServiziByReferenteODelegatoGestoreProgettoAndFiltro(
	 * filtroListaServizi.getCriterioRicerca(),
	 * Arrays.asList(sceltaprofiloParam.getIdProgramma().toString()),
	 * Arrays.asList(sceltaprofiloParam.getIdProgetto().toString()),
	 * filtroListaServizi.getTipologieServizi(),
	 ...
	 * when(this.servizioSqlRepository.
	 * findAllServiziByReferenteODelegatoEntePartnerAndFiltro(
	 * filtroListaServizi.getCriterioRicerca(),
	 * Arrays.asList(sceltaprofiloParam.getIdProgramma().toString()),
	 * Arrays.asList(sceltaprofiloParam.getIdProgetto().toString()),
	 * sceltaprofiloParam.getIdEnte(),
	 ...
	 * )).thenReturn(listaServizi);
	 * List<ServizioEntity> risultato =
	 * servizioSqlService.getAllServiziByReferenteODelegatoEntePartnerAndFiltro(
	 * filtroListaServizi.getCriterioRicerca(),
	 * Arrays.asList(sceltaprofiloParam.getIdProgramma().toString()),
	 * Arrays.asList(sceltaprofiloParam.getIdProgetto().toString()),
	 * sceltaprofiloParam.getIdEnte(),
	 ...
	 * when(this.programmaXQuestionarioTemplateService.getByIdProgramma(
	 * sceltaprofiloParam.getIdProgramma())).thenReturn(listaProgrammaXQuestionario)
	 * ;
	 * when(this.enteSedeProgettoFacilitatoreService.getById(Mockito.any(
	 * EnteSedeProgettoFacilitatoreKey.class))).thenReturn(
	 * enteSedeProgettoFacilitatoreEntity);
	 * when(this.servizioSqlRepository.save(Mockito.any(ServizioEntity.class))).
	 * thenReturn(servizio);
	 * ServizioEntity risultato = servizioSqlService.salvaServizio(servizioRequest,
	 * servizioRequest.getSezioneQuestionarioCompilatoQ3());
	 * assertThat(risultato.getId()).isEqualTo(servizio.getId());
	 * }
	 * 
	 * @Test
	 ...
	 * EnteSedeProgettoFacilitatoreKey.class))).thenReturn(
	 * enteSedeProgettoFacilitatoreEntity);
	 * ServizioEntity risultato = servizioSqlService.creaServizio(servizioRequest,
	 * servizioRequest.getSezioneQuestionarioCompilatoQ3());
	 ...
	 * when(this.programmaXQuestionarioTemplateService.getByIdProgramma(
	 * sceltaprofiloParam.getIdProgramma())).thenReturn(new ArrayList<>());
	 * Assertions.assertThrows(ServizioException.class, () ->
	 * servizioSqlService.creaServizio(servizioRequest,
	 * servizioRequest.getSezioneQuestionarioCompilatoQ3()));
	 ...
	 * when(this.servizioSqlRepository.findById(servizio.getId())).thenReturn(
	 * Optional.of(servizio));
	 * doNothing().when(this.tipologiaServizioRepository).deleteByIdServizio(
	 * servizio.getId());
	 * when(this.servizioSqlRepository.save(Mockito.any(ServizioEntity.class))).
	 * thenReturn(servizio);
	 * ServizioEntity risultato =
	 * servizioSqlService.aggiornaServizio(servizio.getId(), servizioRequest);
	 * assertThat(risultato.getId()).isEqualTo(servizio.getId());
	 * }
	 * 
	 * @Test
	 ...
	 * when(this.ruoloService.getRuoliByCodiceFiscale(sceltaprofiloParam.
	 * getCfUtenteLoggato())).thenReturn(listaRuoli);
	 * when(this.enteSedeProgettoFacilitatoreService.getEntiByFacilitatore(
	 * sceltaprofiloParam)).thenReturn(listaEntiProjection);
	 * List<EnteProjection> risultato =
	 * servizioSqlService.getEntiByFacilitatore(sceltaprofiloParam);
	 ...
	 * when(this.ruoloService.getRuoliByCodiceFiscale(sceltaprofiloParam.
	 * getCfUtenteLoggato())).thenReturn(listaRuoli);
	 * when(this.enteSedeProgettoFacilitatoreService.getSediByFacilitatore(
	 * profilazioneSedeParam)).thenReturn(listaSediProjection);
	 * List<SedeProjection> risultato =
	 * servizioSqlService.getSediByFacilitatore(profilazioneSedeParam);
	 ...
	 * when(this.servizioSqlRepository.findServizioByCittadinoNotEqual(servizio.
	 * getId(), 1L)).thenReturn(Optional.of(servizio));
	 ...
	 * when(this.servizioSqlRepository.
	 * findNominativoFacilitatoreByIdFacilitatoreAndIdServizio("FERSDA89R32G975R",
	 * servizio.getId())).thenReturn("NOMEFACILITATORE");
	 * servizioSqlService.getNominativoFacilitatoreByIdFacilitatoreAndIdServizio(
	 * "FERSDA89R32G975R", servizio.getId());
	 * }
	 * 
	 * @Test
	 * public void getServizioByNomeTest() {
	 * when(this.servizioSqlRepository.findByNome(servizio.getNome())).thenReturn(
	 * Optional.of(servizio));
	 * Optional<ServizioEntity> risultato =
	 * servizioSqlService.getServizioByNome(servizio.getNome());
	 * assertThat(risultato.get().getNome()).isEqualTo(servizio.getNome());
	 * }
	 * 
	 * @Test
	 * public void getServizioByNomeUpdateTest() {
	 * when(this.servizioSqlRepository.findByNomeUpdate(servizio.getNome(),
	 * servizio.getId())).thenReturn(Optional.of(servizio));
	 * Optional<ServizioEntity> risultato =
	 * servizioSqlService.getServizioByNomeUpdate(servizio.getNome(),
	 * servizio.getId());
	 * assertThat(risultato.get().getNome()).isEqualTo(servizio.getNome());
	 * }
	 * 
