...
public class QuestionarioTemplateSqlServiceTest {
	 ...
	 * when(this.templateQuestionarioSqlRepository.countQuestionarioTemplateByFiltro
	 * ("CRITERIORICERCA", "ATTIVO")).thenReturn(1L);
	 * questionarioTemplateSqlService.getNumeroTotaleQuestionariTemplateByFiltro(
	 * "CRITERIORICERCA", "ATTIVO");
	 * }
	 * 
	 * @Test
	 * public void getQuestionariTemplateByIdProgettoTest() {
	 * when(this.templateQuestionarioSqlRepository.
	 * findQuestionarioTemplateByIdProgetto(1L)).thenReturn(new ArrayList<>());
	 * questionarioTemplateSqlService.getQuestionariTemplateByIdProgetto(1L);
	 * }
	 * 
	 * @Test
	 * public void salvaQuestionarioTemplateTest() {
	 * when(this.templateQuestionarioSqlRepository.existsById(
	 * questionarioTemplateEntity.getId())).thenReturn(false);
	 * when(this.templateQuestionarioSqlRepository.save(questionarioTemplateEntity))
	 * .thenReturn(questionarioTemplateEntity);
	 * QuestionarioTemplateEntity risultato =
	 * questionarioTemplateSqlService.salvaQuestionarioTemplate(
	 ...
	 * when(this.templateQuestionarioSqlRepository.existsById(
	 * questionarioTemplateEntity.getId())).thenReturn(true);
	 ...
	 * when(this.templateQuestionarioSqlRepository.findById(
	 * questionarioTemplateEntity.getId())).thenReturn(Optional.of(
	 * questionarioTemplateEntity));
	 * when(this.templateQuestionarioSqlRepository.save(questionarioTemplateEntity))
	 * .thenReturn(questionarioTemplateEntity);
	 * QuestionarioTemplateEntity risultato =
	 * questionarioTemplateSqlService.aggiornaQuestionarioTemplate(
	 * questionarioTemplateEntity);
	 * assertThat(risultato.getId()).isEqualTo(questionarioTemplateEntity.getId());
	 * }
	 * 
	 ...
	 * when(this.templateQuestionarioSqlRepository.findById(
	 * questionarioTemplateEntity.getId())).thenReturn(Optional.empty());
	 * Assertions.assertThrows(QuestionarioTemplateException.class, () ->
	 * questionarioTemplateSqlService.aggiornaQuestionarioTemplate(
	 * questionarioTemplateEntity));
	 * assertThatExceptionOfType(QuestionarioTemplateException.class);
	 ...
	 * questionarioTemplateSqlService.findAllQuestionariTemplatePaginatiByFiltro(
	 * filtroListaQuestionariTemplate.getCriterioRicerca(),
	 * filtroListaQuestionariTemplate.getStatoQuestionario(),
	 * filtroListaQuestionariTemplate.getCurrPage(),
	 * filtroListaQuestionariTemplate.getPageSize());
	 ...
	 * )).thenReturn(listaQuestionari);
	 * List<QuestionarioTemplateEntity> risultato =
	 * questionarioTemplateSqlService.findAllQuestionariTemplateByFiltro(
	 * filtroListaQuestionariTemplate.getCriterioRicerca(),
	 * filtroListaQuestionariTemplate.getStatoQuestionario());
	 * assertThat(risultato.size()).isEqualTo(listaQuestionari.size());
	 * }
	 ...
	 * when(this.templateQuestionarioSqlRepository.findAllStatiDropdownByFiltro(
	 * filtroListaQuestionariTemplate.getCriterioRicerca(),
	 * filtroListaQuestionariTemplate.getStatoQuestionario())).thenReturn(new
	 * ArrayList<String>());
	 * questionarioTemplateSqlService.findAllStatiDropdownByFiltro(
	 * filtroListaQuestionariTemplate.getCriterioRicerca(),
	 * filtroListaQuestionariTemplate.getStatoQuestionario());
	 * }
	 * 
	 ...
	 * filtroListaQuestionariTemplate.getPageSize()
	 * )).thenReturn(listaQuestionari);
	 * List<QuestionarioTemplateEntity> risultato = questionarioTemplateSqlService.
	 ...
	 * )).thenReturn(listaQuestionari);
	 * List<QuestionarioTemplateEntity> risultato =
	 * questionarioTemplateSqlService.findQuestionariTemplateByIdProgrammaAndFiltro(
	 * 1L,
	 * filtroListaQuestionariTemplate.getCriterioRicerca(),
	 * filtroListaQuestionariTemplate.getStatoQuestionario());
	 * assertThat(risultato.size()).isEqualTo(listaQuestionari.size());
	 ...
	 * when(this.templateQuestionarioSqlRepository.findAll()).thenReturn(
	 * listaQuestionari);
	 * List<QuestionarioTemplateEntity> risultato =
	 * questionarioTemplateSqlService.getAllQuestionari();
	 * assertThat(risultato.size()).isEqualTo(listaQuestionari.size());
	 * }
	 * 
	 * @Test
	 * public void getQuestionariSCDTest() {
	 * when(this.templateQuestionarioSqlRepository.findQuestionariSCD()).thenReturn(
	 * listaQuestionari);
	 * List<QuestionarioTemplateEntity> risultato =
	 * questionarioTemplateSqlService.getQuestionariSCD();
	 * assertThat(risultato.size()).isEqualTo(listaQuestionari.size());
	 * }
	 * 
	 * @Test
	 ...
	 * when(this.templateQuestionarioSqlRepository.findQuestionariRFD()).thenReturn(
	 * listaQuestionari);
	 * List<QuestionarioTemplateEntity> risultato = questionarioTemplateSqlService.
	 * getQuestionariPerReferenteDelegatoGestoreProgramma(programma.getId());
	 * assertThat(risultato.size()).isEqualTo(listaQuestionari.size());
	 * 
	 ...
	 * when(this.templateQuestionarioSqlRepository.findQuestionariSCD()).thenReturn(
	 * listaQuestionari);
	 * List<QuestionarioTemplateEntity> risultato2 = questionarioTemplateSqlService.
	 * getQuestionariPerReferenteDelegatoGestoreProgramma(programma.getId());
	 ...
	 * doNothing().when(this.templateQuestionarioSqlRepository).deleteById(
	 * questionarioTemplateEntity.getId());
	 * questionarioTemplateSqlService.cancellaQuestionarioTemplate(
	 * questionarioTemplateEntity.getId());
	 * }
	 * 
	 * @Test
	 ...
	 * when(this.templateQuestionarioSqlRepository.
	 * findQuestionarioTemplateDefaultRFD()).thenReturn(Optional.of(
	 * questionarioTemplateEntity));
	 * Optional<QuestionarioTemplateEntity> risultato =
	 * questionarioTemplateSqlService.getQuestionarioTemplateDefaultRFD();
	 * assertThat(risultato.get().getId()).isEqualTo(questionarioTemplateEntity.
	 * getId());
	 * }
	 * 
	 * @Test
	 ...
	 * when(this.templateQuestionarioSqlRepository.
	 * findQuestionarioTemplateDefaultSCD()).thenReturn(Optional.of(
	 * questionarioTemplateEntity));
	 * Optional<QuestionarioTemplateEntity> risultato =
	 * questionarioTemplateSqlService.getQuestionarioTemplateDefaultSCD();
	 * assertThat(risultato.get().getId()).isEqualTo(questionarioTemplateEntity.
	 * getId());
	 * }
	 * 
	 ...
	 * questionarioTemplateEntity));
	 * QuestionarioTemplateEntity risultato =
	 * questionarioTemplateSqlService.getQuestionarioTemplateById(
	 * questionarioTemplateEntity.getId());
	 * assertThat(risultato.getId()).isEqualTo(questionarioTemplateEntity.getId());
	 * }
	 * 
