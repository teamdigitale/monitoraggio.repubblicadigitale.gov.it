 ...
 *   label = @Translation("Api to manage community item dinamic filters"),
 *   uri_paths = {
 *     "canonical" = "/api/community/filters"
 *   }
 * )
 */
class CommunityFiltersResourceApi extends ResourceBase
{
  /**
  ...
  public function get(Request $req)
  {
    try {
      ...
      return ResponseFormatterController::success($data, 200, 'community_item_cache');
    } catch (Exception $ex) {
