 ...
 *
 * @RestResource(
 *   id = "view_resource_api",
 *   label = @Translation("Api to Increment the amount of views of an item"),
 *   uri_paths = {
 *     "create" = "/api/item/{id}/view"
 *   }
 * )
 */
class ViewApiController extends ResourceBase
{
  /**
