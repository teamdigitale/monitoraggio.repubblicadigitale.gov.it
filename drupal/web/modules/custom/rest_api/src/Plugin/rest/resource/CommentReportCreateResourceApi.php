 ...
 *
 * @RestResource(
 *   id = "comment_report_create",
 *   label = @Translation("Api to create a new report for a comment"),
 *   uri_paths = {
 *     "create" = "/api/comment/{id}/report"
 *   }
 * )
 */
class CommentReportCreateResourceApi extends ResourceBase
{
  /**
