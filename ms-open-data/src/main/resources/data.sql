...
CREATE TABLE count_download_file (
  nome_file varchar(255) NOT NULL,
  count bigint NOT NULL,
  last_download TIMESTAMP NOT NULL default CURRENT_TIMESTAMP,
  dimensione_file_opendata varchar(255),
  PRIMARY KEY (nome_file)
  );

INSERT INTO count_download_file (nome_file, count, last_download, dimensione_file_opendata) VALUES ('prova', '2', '2022-09-16 13:30:21', '15701');
