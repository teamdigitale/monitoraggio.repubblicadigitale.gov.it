...
public class RuoloServiceTest {
	...
	public void getRuoliCompletiByCodiceFiscaleUtenteTest() {
		...
		assertThat(service.getRuoliCompletiByCodiceFiscaleUtente("codiceFiscale").get(0).getCodice())
				.isEqualTo("codice");
	}
	...
	public void aggiornaRuoloNonPredefinitoTest() {
		...
		doNothing().when(this.ruoloXGruppoService).aggiornaAssociazioniRuoloGruppo(ruolo.getCodice(),
				ruoloRequest.getCodiciGruppi());
		service.aggiornaRuoloNonPredefinito("codice", ruoloRequest);
	...
	public void getSchedaRuoloByCodiceRuoloTest() {
		...
		assertThat(service.getSchedaRuoloByCodiceRuolo("codice").getDettaglioRuolo().getNome())
				.isEqualTo(ruolo.getNome());
	}
}
